...
import client.SalesforceOAuthClient;
...
//		s_url = s_url + code;
		...
		String refreshToken = cli.getRefreshToken(code);
		String accessToken = cli.getAccessToken(refreshToken);
		String accounts = cli.getAccounts(accessToken);
...
//		
		...
		response.getWriter().append(accounts);
	}
